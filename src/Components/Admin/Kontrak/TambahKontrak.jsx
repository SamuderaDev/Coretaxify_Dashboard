...
const TambahKontrak = ({ isOpen, onClose, onSave, UniData }) => {
            ...
            <div className="kontrak-popup-container">
                ...
                <form>
                    ...
                    <div className="kontrak-form-group">
                        ...
                        <select name="instansi" value={formData.instansi} onChange={handleChange} required>
